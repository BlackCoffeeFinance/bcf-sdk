...
import { SwapTypes, PoolFilter, SOR } from 'bcf-sor';
export { PoolFilter, SOR, SwapTypes, phantomStableBPTForTokensZeroPriceImpact, queryBatchSwapTokensIn, queryBatchSwapTokensOut, stableBPTForTokensZeroPriceImpact, weightedBPTForTokensZeroPriceImpact } from 'bcf-sor';
...
const BALANCER_NETWORK_CONFIG = {
    ...
    [Network.BINANCE_SMART_CHAIN]: {
        chainId: Network.BINANCE_SMART_CHAIN,
        addresses: {
            contracts: {
                vault: '0x65748E8287Ce4B9E6D83EE853431958851550311',
